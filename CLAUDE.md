...
Перед любыми выводами или изменениями полностью прочитать
`CONTEXT_HANDOFF.md`, затем проверить указанные там branch/HEAD/PR командами
Git. После материальной работы обновить handoff, чтобы следующий контекст не
начинал с догадок.
