...
4. CDN продаётся отдельно от обычной подписки — пакетами гигабайтов через Telegram. Клиент должен видеть назначение CDN, размер и цену пакета, понятный путь оплаты, остаток и состояние покупки. Не создавать фиктивные оплаты или повторные начисления.
