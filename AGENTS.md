...
Последнее уточнение владельца после повторной жалобы: пинг есть, YouTube/Instagram/Telegram/WhatsApp работают. На окно12:06–12:09UTC сторож действительно видел8active, запасlease44–59с и положительный внутреннийcredit, безfencing/errors. Поэтому предыдущийfencing11:49НЕобъясняетавтоматическиреплику12:08. Оплаченныйостаток отдельно сверён вrqlite:положительный,основнаяподпискаactive,pending/uncovered/pending-debits=0,резервы значительно меньшеостатка. Историческаяточнаяпричинаfenceнеpersisted; невыдумыватьеё. Сейчас оставитьheader-правку и нерасширятьизменения: текущее соединение подтверждено владельцем, долговременнаястабильность/полноеустранениеn/a не доказаны. Следующий новыйобрыв сопоставлятьсегофактическимвременем и отличатьn/aототсутствияинтернета.
