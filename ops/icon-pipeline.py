...
# ── 3) TV BANNER 640×360 (вензель слева-центр на чёрном + мягкое зелёное свечение) ──
ban = Image.new("RGBA", (640, 360), (8, 8, 8, 255))
glow = Image.new("RGBA", (640, 360), (0, 0, 0, 0))
gd = ImageDraw.Draw(glow)
gd.ellipse((70, 60, 370, 300), fill=(34, 200, 110, 60))
ban = Image.alpha_composite(ban, glow.filter(ImageFilter.GaussianBlur(60)))
vm = content.resize((260, 260), Image.LANCZOS)
ban.paste(vm, (60, 50), vm)
save(ban.convert("RGB").convert("RGBA"), f"{RES}/drawable-xhdpi/tv_banner.png"); n += 1
