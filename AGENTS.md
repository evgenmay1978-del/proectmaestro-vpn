## Текущие правила мобильного продолжения — 10.09.2026

Владелец требует настоящий «вау» качеством и естественностью глаза внутри утверждённого дерево/золото/изумруд интерфейса. Никаких4D, параллакса, покачивания, пульсации света. Рамка/орнамент неподвижны; глаз двигает взгляд/зрачок и смыкает зелёные веки. Сначала показать целый экран и движение для решения владельца. Кандидат6f586d8/code1016002 с цельной поверхностью собран и прошёл адресный GitHub native preview; OFF/ON/MP4 готовы, согласование ещё ожидается. Не объявлять «вау»/готовность по числу тестов.13старых референсов удалены; утверждённые источники/runtime assets сохранены.

Controller b14738d установлен: публичный runtime200/4профиля за1790ms, wireTTL4s. В кандидате Android HTTP budget3s и ранний renew по RTT;5s/absolute deadline и закрытие приexpiry сохранены. Реальное CDN-подключение новогоAPK владельцем ещё не подтверждено. Обычная панель/front/env/Xray/боты/суммы сохранены; старые lease-расследования не повторять. Новое приложение сохраняет package/fleet-подпись/TV; опубликовано пока160/1016001, ARM1016002 ещё не собран. После решения по интерфейсу — необходимая ARM-сборка/доставка без повтора полного набора. Сборки/эмулятор/адресные тесты только GitHub.
