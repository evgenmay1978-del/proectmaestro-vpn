...
Уточнение владельца от 10.09.2026: последняя версия — 1.0.157. Считать157 исходной версией владельца; установка159 у него не подтверждена. 160 — подготовленный, ещё не опубликованный кандидат. История сборки/раздачи159 не является доказательством версии на телефоне.

APK160 собран с прежней подписью; настоящий интерфейс ещё не просмотрен из-за сбоев ARM-трансляции на GitHub. Следующий шаг — физический Android и показ его экранов. Не продолжать перебор эмуляторов/менять рабочее ядро ради снимков; до реальных экранов OTA160 не публиковать и готовность интерфейса не утверждать. Остальные правила реализации и сохранения сервиса действуют.
