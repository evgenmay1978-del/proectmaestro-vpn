...
if (cdnApkBuild) {
    ...
    require(1016003 > productionVersionCode) { "CDN APK version must exceed the source version" }
}

val effectiveVersionName = if (cdnApkBuild) "1.0.160" else task7TestVersionNameProperty ?: productionVersionName
val effectiveVersionCode = if (cdnApkBuild) 1016003 else task7TestVersionCode ?: productionVersionCode
android {
